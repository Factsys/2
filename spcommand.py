...
# New command: ,spall (all deleted messages from all channels)
...
# New command: ,splall (all deleted links from all channels or specific channel/thread)
...
# New command: ,spfall (all clean messages from all channels or specific channel/thread)
